...
import "@adrastia-oracle/adrastia-core/contracts/accumulators/proto/aave/AaveV3SBAccumulator.sol";

import "../../AccumulatorConfig.sol";

contract ManagedAaveV3SBAccumulator is AaveV3SBAccumulator, AccumulatorConfig {
    constructor(
