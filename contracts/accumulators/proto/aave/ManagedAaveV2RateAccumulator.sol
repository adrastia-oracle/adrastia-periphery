...
import "@adrastia-oracle/adrastia-core/contracts/accumulators/proto/aave/AaveV2RateAccumulator.sol";

import "../../AccumulatorConfig.sol";

contract ManagedAaveV2RateAccumulator is AaveV2RateAccumulator, AccumulatorConfig {
    constructor(
