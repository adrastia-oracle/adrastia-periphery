...
import "@adrastia-oracle/adrastia-core/contracts/accumulators/proto/compound/CometSBAccumulator.sol";

import "../../AccumulatorConfig.sol";

contract ManagedCometSBAccumulator is CometSBAccumulator, AccumulatorConfig {
    constructor(
