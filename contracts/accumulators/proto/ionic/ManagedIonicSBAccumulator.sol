...
import "@adrastia-oracle/adrastia-core/contracts/accumulators/proto/ionic/IonicSBAccumulator.sol";

import "../../AccumulatorConfig.sol";

contract ManagedIonicSBAccumulator is IonicSBAccumulator, AccumulatorConfig {
    constructor(
