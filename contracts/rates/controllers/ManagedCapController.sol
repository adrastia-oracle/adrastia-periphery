...
import "./CapController.sol";
import ".././../access/Roles.sol";

/**
 * @title ManagedCapController
 * @notice A smart contract that extends CapController and AccessControlEnumerable to manage and update rates with
 * access control restrictions based on roles.
 */
contract ManagedCapController is CapController, AccessControlEnumerable {
