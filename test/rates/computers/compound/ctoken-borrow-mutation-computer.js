...
describe("CTokenBorrowMutationComputer#constructor", function () {
    var factory;

    beforeEach(async function () {
        factory = await ethers.getContractFactory("CTokenBorrowMutationComputer");
    });
...
describe("CTokenBorrowMutationComputer#getValue", function () {
    var computer;
    var token;
    var cToken;
            ...
            for (const decimalsOffset of decimalOffsetsToTest) {
                describe(`Using a decimals offset of ${decimalsOffset}`, function () {
                    describe("Using a token with 18 decimals", function () {
                        beforeEach(async function () {
                            const computerFactory = await ethers.getContractFactory("CTokenBorrowMutationComputerStub");
...
describe("CTokenBorrowMutationComputer#setConfig", function () {
    var computer;
...
describe("CTokenBorrowMutationComputer#supportsInterface", function () {
    var interfaceIds;
    var computer;

    beforeEach(async function () {
        const computerFactory = await ethers.getContractFactory("CTokenBorrowMutationComputer");
        computer = await computerFactory.deploy(DEFAULT_ONE_X_SCALAR, DEFAULT_DECIMALS, DEFAULT_DECIMAL_OFFSET);
