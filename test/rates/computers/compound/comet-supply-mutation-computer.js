...
describe("CometSupplyMutationComputer#constructor", function () {
    var factory;

    var comet;

    beforeEach(async function () {
        factory = await ethers.getContractFactory("CometSupplyMutationComputer");
...
describe("CometSupplyMutationComputer#getValue", function () {
    var computer;
    var token;
    var comet;
    ...
    function describeTests(decimals, decimalsOffset) {
        for (const amount of commonTests) {
            ...
            it(`Works with a supply of ${amount.toString()}, and the result is ${expected.toString()}`, async function () {
                await comet.stubSetTotalSupply(amount);
                ...
                describe(`Using a decimals offset of ${decimalsOffset}`, function () {
                    describe("Using a token with 18 decimals", function () {
                        beforeEach(async function () {
                            ...
                            const computerFactory = await ethers.getContractFactory("CometSupplyMutationComputerStub");
...
describe("CometSupplyMutationComputer#setConfig", function () {
    var computer;
...
describe("CometSupplyMutationComputer#supportsInterface", function () {
    var interfaceIds;
    var computer;
    ...
    beforeEach(async function () {
        ...
        const computerFactory = await ethers.getContractFactory("CometSupplyMutationComputer");
        computer = await computerFactory.deploy(
            comet.address,
            DEFAULT_ONE_X_SCALAR,
            DEFAULT_DECIMALS,
