...
describe("PositiveErrorScalingTransformer", function () {
    describe("PositiveErrorScalingTransformer#constructor", function () {
        var factory;

        before(async function () {
            factory = await ethers.getContractFactory("PositiveErrorScalingTransformer");
        });
    ...
    describe("PositiveErrorScalingTransformer#transformInputAndError", function () {
        var factory;
